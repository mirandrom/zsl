...
class SchedulerConfig(BaseConfig):
    ...
    t_cooldown: Optional[Union[int, float]] = None
...
class DataConfig(BaseConfig):
    ...
    global_indices_file: Optional[str] = None
...
class TrainConfig(BaseConfig):
    ...
    save_interval_unsharded_log2: bool = False # ZSL
    """
    Override behavior of save_interval_unsharded, saving at steps [0,1,2,4,8,16,32,...] instead.
    """
